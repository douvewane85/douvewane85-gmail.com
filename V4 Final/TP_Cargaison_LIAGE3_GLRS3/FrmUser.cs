...
namespace TP_Cargaison_LIAGE3_GLRS3
{
    ...
    public partial class FrmUser : Form
    {
        ...
        private void bntPrec_Click(object sender, EventArgs e)
        {
            ActiveNavigation();
            int rowIndex = dtgvUser.CurrentRow.Index-1;
            dtgvUser.CurrentCell = dtgvUser.Rows[rowIndex].Cells[dtgvUser.CurrentCell.ColumnIndex];
            dtgvUser.Rows[rowIndex].Selected = true;
            loadForm(dtgvUser.Rows[rowIndex]);
        ...
        {
            btnNext.Enabled = dtgvUser.CurrentRow.Index < dtgvUser.RowCount-2;
            btnPrec.Enabled = dtgvUser.CurrentRow.Index > 1 ;
        }
